...
const SystemSettingsView = () => {
  ...
  const formSwitchItems = [
    {
      label: "Automatische App Updates",
  ...
  const formSwitchItemsMongo = [
    ...
    {
      label: "Warteschlange bei Verbindungsausfall zu MongoDB",
      name: "save_counts_to_queue_if_mongo_down",
      disabled: true,
    },
    {
      label: "Bei Ausfall versuchen Daten in Datei zu speichern",
      name: "ensure_not_data_loss_to_file",
      disabled: true,
    },
  ];
  ...
  return (
    <>
      ...
      >
        <Title level={4}>Geräteeinstellungen</Title>
        <Divider />
